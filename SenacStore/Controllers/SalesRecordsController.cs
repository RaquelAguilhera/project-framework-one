...
namespace SenacStore.Controllers
{
    public class SalesRecordsController : Controller
    {
        ...
        public SalesRecordsController(SenacStoreContext context)
        {
            _context = context;
        }
        ...
        {
            var senacStoreContext = _context.SalesRecord.Include(s => s.Seller);
            return View(await senacStoreContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SenacStoreContext.SalesRecord'  is null.");
            }
            var salesRecord = await _context.SalesRecord.FindAsync(id);
            if (salesRecord != null)
            {
