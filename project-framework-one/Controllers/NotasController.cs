...
namespace project_framework_one.Controllers
{
    public class NotasController : Controller
    {
        ...
        public NotasController(project_framework_oneContext context)
        {
            _context = context;
        }
        ...
        {
            var project_framework_oneContext = _context.Nota.Include(n => n.pedido);
        ...
        public async Task<IActionResult> Create([Bind("Id,Total,PedidoId")] Nota nota)
        {
           ...
           // }
           // ViewData["PedidoId"] = new SelectList(_context.Pedido, "Id", "Id", nota.PedidoId);
           /// return View(nota);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Total,PedidoId")] Nota nota)
        {
            if (id != nota.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'project_framework_oneContext.Nota'  is null.");
            }
            var nota = await _context.Nota.FindAsync(id);
            if (nota != null)
            {
